...
function finpay_plugin_action_links($links){
  $plugin_links = array(
      ...
      '<a target="_blank" href="https://docs.finpay.com/en/snap/with-plugins?id=wordpress-woocommerce">' . __('Documentation', 'finpay-woocommerce') . '</a>',
      '<a target="_blank" href="https://github.com/veritrans/SNAP-Woocommerce/wiki">' . __('Wiki', 'finpay-woocommerce') . '</a>',
  );
