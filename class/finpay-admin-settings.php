...
$sandbox_key_url = 'https://dashboard.sandbox.finpay.com/settings/config_info';
$production_key_url = 'https://dashboard.finpay.com/settings/config_info';
/**
...
return apply_filters(
	...
	array(
        ...
        'merchant_id'                => array(
            'title'         => __("Merchant ID", 'finpay-woocommerce'),
            'type'          => 'text',
            'description'   => sprintf(__('Input your finpay Merchant ID (e.g G428268669 or M012345). Get the ID <a href="%s" target="_blank">here</a>', 'finpay-woocommerce' ),$sandbox_key_url),
            'default'       => '',
        ),
