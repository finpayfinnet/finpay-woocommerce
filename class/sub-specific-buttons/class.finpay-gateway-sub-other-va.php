 ...
 */
class WC_Gateway_Finpay_Sub_Other_VA extends WC_Gateway_Finpay_Abstract_Sub {
  function __construct() {
    // used as plugin id
    $this->id = 'Finpay_sub_other_va';
  ...
  public function pluginTitle() {
    return "Finpay Specific: Bank Transfer Other";
  }
  public function getSettingsDescription() {
    return "Separated payment buttons for this specific the payment methods with its own icons";
  }
  protected function getDefaultTitle () {
    return __('Bank Transfer - Other', 'Finpay-woocommerce');
  }
  protected function getDefaultDescription () {
    return __('Bank Transfer for other banks', 'Finpay-woocommerce');
  }
}