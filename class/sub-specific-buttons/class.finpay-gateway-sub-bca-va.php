 ...
 */
class WC_Gateway_Finpay_Sub_BCA_VA extends WC_Gateway_Finpay_Abstract_Sub {
  function __construct() {
    // used as plugin id
    $this->id = 'finpay_sub_bca_va';
  ...
  public function pluginTitle() {
    return "Finpay Specific: Bank Transfer BCA VA";
  }
  public function getSettingsDescription() {
    return "Separated payment buttons for this specific the payment methods with its own icons";
  }
  protected function getDefaultTitle () {
    return __('Bank Transfer - BCA VA', 'Finpay-woocommerce');
  }
  protected function getDefaultDescription () {
    return __('Only accept transfer from BCA account.', 'Finpay-woocommerce');
  }
}