 ...
 */
class WC_Finpay_Logger {
    /**
     * Utilize WC logger class
     */
    public static function log( $message, $log_file_name, $plugin_id = 'finpay', $start_time = null, $end_time = null ) {
        if ( ! class_exists( 'WC_Logger' ) ) {
          return;
        }
  
        if ( apply_filters( 'wc_finpay_logging', true, $message ) ) {
          ...
          if ( ! is_null( $start_time ) ) {
            ...
            $log_entry  = "\n" . '====Finpay Plugin Version: ' . FINPAY_PLUGIN_VERSION . '====' . "\n";
