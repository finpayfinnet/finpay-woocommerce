      ...
      function init_form_fields() {
        ...
        WC_Midtrans_Utils::array_insert( $this->form_fields, 'enable_3d_secure', array(
          ...
          'installment_bank' => array(
            'title' => __( 'Installment Bank(s)', 'finpay-woocommerce' ),
            'type' => 'text',
            'description' => __( 'Input the desired installment bank(s). Separate with coma for multiple banks. e.g: bni,mandiri,bca', 'finpay-woocommerce' ),
