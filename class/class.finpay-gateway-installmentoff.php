<?php
    /**
     * Finpay Offline Installment Payment Gateway Class
     * Duplicated from `class.finpay-gateway.php`
     * Check `class.finpay-gateway.php` file for proper function comments
     */
    class WC_Gateway_Finpay_InstallmentOff extends WC_Gateway_Finpay_Abstract {

      /**
       * Constructor
       */
      function __construct() {
        $this->id           = 'finpay_installment_offline';
      ...
      public function init_form_fields() {
        ...
        WC_Finpay_Utils::array_insert( $this->form_fields, 'enable_3d_secure', array(
          'installment_term' => array(
            ...
            'type' => 'text',
            'description' => __( 'Input the desired Installment Terms. Separate with coma. e.g: 3,6,12', 'finpay-woocommerce' ),
            'default' => '3,6,12'
          ),
          'acquiring_bank' => array(
            'title' => __( 'Acquiring Bank', 'finpay-woocommerce' ),
            'type' => 'text',
            'description' => __( 'Input the desired acquiring bank. e.g: bni </br>Leave blank if you are not sure', 'finpay-woocommerce' ),
            'default' => ''
          ),
          'min_amount' => array(
            'title' => __( 'Minimal Transaction Amount', 'finpay-woocommerce'),
            'type' => 'int',
            'label' => __( 'Minimal Transaction Amount', 'finpay-woocommerce' ),
            'description' => __( 'Minimal transaction amount allowed to be paid with installment. (amount in IDR, without comma or period) example: 500000 </br> if the transaction amount is below this value, customer will be redirected to Credit Card fullpayment page', 'finpay-woocommerce' ),
            'default' => '500000'
          ),
          'bin_number' => array(
      ...
      public function pluginTitle() {
        return "Finpay Adv: Offline Installment";
      }
      ...
      protected function getDefaultTitle () {
        return __('Credit Card Installment for other bank via Finpay', 'finpay-woocommerce');
      }
      ...
      protected function getSettingsDescription() {
        return __('Setup Finpay card payment with Off-Us <a href="https://github.com/veritrans/SNAP-Woocommerce/wiki/02---Credit-card-online-and-offline-installment">Installment(Cicilan) feature</a>, only used if you already have agreement with bank (leave it disabled if not sure).', 'finpay-woocommerce');
      }
      ...
      protected function getDefaultDescription () {
        return __('Minimal transaction amount allowed for credit card installment is Rp. ' . $this->get_option( 'min_amount' ) . '</br> You will be redirected to fullpayment page if the transaction amount below this value', 'finpay-woocommerce');
      }
